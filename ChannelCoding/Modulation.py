...
# Завадостійкість методів модуляції
...
def main(ask, psk, fsk1, fsk2):
    # генерування цифрової послідовністі, розрахунок часових відліків та побудува її графіку
    ...
    # демодуляція отриманих сигналів з шумом та відображення демодульованого сигналу та демодульованої послідовністі для трьох типів модуляції
    ...
    # розрахунок завадостійкості кожного метода модуляції та побудова графіків залежності ймовірності помилки від рівня завад
