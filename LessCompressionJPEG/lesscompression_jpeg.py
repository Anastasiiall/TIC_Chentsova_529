...
def load_quantization_table(component):
    if component == 'lum':
        # q = np.array(
        #     [[2, 2, 2, 2, 3, 4, 5, 6], [2, 2, 2, 2, 3, 4, 5, 6], [2, 2, 2, 2, 4, 5, 7, 9], [2, 2, 2, 4, 5, 7, 9, 12],
        #      [3, 3, 4, 5, 8, 10, 12, 12], [4, 4, 5, 7, 10, 12, 12, 12], [5, 5, 7, 9, 12, 12, 12, 12],
        #      [6, 6, 9, 12, 12, 12, 12, 12]])
        q = np.array([[16, 11, 10, 16, 24, 40, 51, 61],  [12, 12, 14, 19, 26, 48, 60, 55], [14, 13, 16, 24, 40, 57, 69, 56], [14, 17, 22, 29, 51, 87, 80, 62], [18, 22, 37, 56, 68, 109, 103, 77], [24, 35, 55, 64, 81, 104, 113, 92], [49, 64, 78, 87, 103, 121, 120, 101], [72, 92, 95, 98, 112, 100, 103, 99]])
    elif component == 'chrom':
        # q = np.array([[3, 3, 5, 9, 13, 15, 15, 15], [3, 4, 6, 11, 14, 12, 12, 12], [5, 6, 9, 14, 12, 12, 12, 12],
        #               [9, 11, 14, 12, 12, 12, 12, 12], [13, 14, 12, 12, 12, 12, 12, 12],
...
input_file = 'C:/Image/15_3.bmp'
output_file = 'C:/Image/15_3.asf'
...
def encode():
    ...
    with open("Results/results_jpeg.txt", "a") as file:
        print('Дані для слаботекстурного зображення RGB (таблиця 2), зображення 15_3', file=file)
...
def decoder():
    ...
    filename = f"JPEG_{'decode_image_15_3(2)'}.jpg"
    image.save(filename)
