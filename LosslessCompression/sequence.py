...
text = open('LosslessCompression/results_sequence.txt', 'w')
# 1
N_sequence = 100
N1 = 15
list1 = [1]*N1
...
list0 = [0]*N0
results = []
sequence = open('LosslessCompression/sequence.txt', 'r')
...
text = open('LosslessCompression/results_sequence.txt', 'a')
...
seq = open('LosslessCompression/sequence.txt', 'w')
...
table.scale(0.8, 2)
fig.savefig('./LosslessCompression/' + 'Характеристики сформованих послідовностей' + '.png')
